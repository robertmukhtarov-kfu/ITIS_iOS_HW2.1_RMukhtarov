...
internal enum Asset {
  ...
  internal enum Avatars {
    internal static let jacob = ImageAsset(name: "Avatars/jacob")
    internal static let jessica = ImageAsset(name: "Avatars/jessica")
    internal static let kat = ImageAsset(name: "Avatars/kat")
    internal static let kim = ImageAsset(name: "Avatars/kim")
    internal static let mia = ImageAsset(name: "Avatars/mia")
    internal static let steve = ImageAsset(name: "Avatars/steve")
